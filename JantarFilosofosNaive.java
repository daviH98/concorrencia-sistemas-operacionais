public class JantarFilosofosNaive {
    ...
    static class Filosofo extends Thread {
        ...
        public void run() {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                synchronized (garfos[garfoEsq]) {
                    System.out.printf("Filósofo %d pegou o garfo %d (esquerda)%n", id, garfoEsq);
                    dormir(50);

                    synchronized (garfos[garfoDir]) {
                        System.out.printf("Filósofo %d pegou o garfo %d (direita)%n", id, garfoDir);
                        comer();
                    }
                }
